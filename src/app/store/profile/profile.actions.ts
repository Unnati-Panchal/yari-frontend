...
export const uploadKYCDocs = createAction('[PROFILE] uploadKYCDocs', props<{ uploadKYCDocsReq: IFileKYC }>());
export const uploadKYCDocsSuccess = createAction('[PROFILE] uploadKYCDocs success', props<{ uploadedKYCDocs: IRegistration }>());
export const uploadKYCDocsError = createAction('[PROFILE] uploadKYCDocs error', props<{ error: HttpErrorResponse }>());

export const updateKYCDocs = createAction('[PROFILE] updateKYCDocs', props<{ updateKYCDocsReq: IFileKYC }>());
export const updateKYCDocsSuccess = createAction('[PROFILE] updateKYCDocs success', props<{ updatedKYCDocs: IRegistration }>());
export const updateKYCDocsError = createAction('[PROFILE] updateKYCDocs error', props<{ error: HttpErrorResponse }>());
